...
def parse_args(train, validation):
    ...
    parser.add_argument('--pretrained_model', type=str,
                        default='Skeleton_FE_Guided_PD_Diagnosis/checkpoints/ckpt_fer/ckpt_fer_train&val_8413.pth',
    ...
    parser.add_argument('-c', '--checkpoint', type=str, 
                        default='Skeleton_FE_Guided_PD_Diagnosis/checkpoints/ckpt_fer/ckpt_fer_train&val_8492.pth', 
...
def run_train(args):
    ...
    with open(os.path.join(log_path, 'log-'+time.strftime("%Y-%m-%d-%H-%M-%S-",
        ...
        model = Res_fer_nofreeze(pretrained=args.pretrained_model, num_classes=6) 
        ...
        ckpt_path = os.path.join(args.ckpt_dir, 'premodel_filename')
