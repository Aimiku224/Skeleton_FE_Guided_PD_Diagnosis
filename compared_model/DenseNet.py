...
class woclassifier_DenseNet(nn.Module):
    """
    Densenet-BC model class for imagenet
    ...
    def __init__(self,
                 ...
                 num_classes: int = 1000,
                 memory_efficient: bool = False):
        super(woclassifier_DenseNet, self).__init__()
...
def woclassifier_densenet121(**kwargs: Any) -> DenseNet:
    # Top-1 error: 25.35%
    # 'densenet121': 'https://download.pytorch.org/models/densenet121-a639ec97.pth'
    return woclassifier_DenseNet(growth_rate=32,
                    block_config=(6, 12, 24, 16),
                    num_init_features=64,
                    **kwargs)
